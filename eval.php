...
<body>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-9">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i> <strong>Evaluation Details</strong></h3>
              <?php
        ...
        <div class="row">
          <div class="col-lg-11">
            <section class="panel">
             ...
             <form class="form-horizontal " action="includes/assess.inc.php"method="post" enctype="multipart/form-data">
                 
<div class="form-group row">
                    
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label"><strong>Name of Evaluation</strong></label>
                    <div class="col-sm-4">
                      <input type="text"  name="name" class="form-control " required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label"><strong>Select Date</strong></label>
                    <!-- <small>(Seperated by comma)</small> -->
                    <div class="col-sm-4">
                      <input type="date" min="<?php echo date("Y-m-d");?>" name="date" class="form-control" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label"><strong>Total marks of Evaluation</strong></label>
                    <div class="col-sm-4">
                      <input type="text"  name="outofmarks" class="form-control " required>
                    </div>
                  </div>
             ...
             <a href="super_profile.php" class="btn btn-primary">Go Back</a>
</div>
             </div>
