...
<body>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-9">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i> <strong>Final Evaluation</strong></h3>
              <?php
              $id=$_GET['id'];
        ...
        <div class="row">
          <div class="col-lg-11">
            <section class="panel">
              ...
              <form class="form-horizontal " action="includes/finalmarking.inc.php"  method="post" enctype="multipart/form-data">
...
<div class="form-group row">
    ...
    ?>
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label"><strong>Final Grade</strong></label>
                    <div class="col-sm-4">
