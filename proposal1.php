...
<div class="wrapper">
        <div class="title">Propose Topic</div><br>
        <form action="includes/proposal.inc.php "method="post" enctype="multipart/form-data">
            <div class="user-details">
                <div class="input-box">
                    <span class="details"><strong>Thesis Topic</strong></span>
                    <input type="text"  name="topic"  required>
                </div>
                <div class="input-box">
                    <span class="details"><strong>Topic Area(s)</strong><small>(Seperated by comma)</small></span>
                    <input type="text" name="keyword" required>
                </div>
                <div class="input-box">
                    <span class="details"><strong>Abstract</strong></span>
                    <textarea type="text" name="abstract" style="width:100%;" rows="4" cols="50" required></textarea>
                </div>
                <div style="display: flex; flex-wrap: wrap;justify-content: space-between;">
                    ...
                    <div class="select">
                        <span class="details"> Select Supervisor:</span>
