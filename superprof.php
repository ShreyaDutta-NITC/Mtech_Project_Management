...
<table id="example" class="table table-stri ped table-bordered" style="width:100%;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                ...
                <tbody>
                  <tr>
                    ...
                    <th><h3><strong><center>Report</center></strong></h3></th>
                  ...
                  $sqlx="SELECT COUNT(*) from thesis WHERE supervisor_name='$name' AND status = 2";
                  ...
                  while ($row = mysqli_fetch_array($result1))
                  {
                    ...
                    $row2 = mysqli_fetch_array($result2);
                              ...
                              <td><a href="table.php?id='.$row['id'].'">Check Remarks </a></td>
                              <td><a href="pdfgenerator.php?id='.$row['id'].'">Generate Report </a></td>';
                      ...
                      echo '<h3><strong>No completed projects yet</strong></h3>';
                    }
