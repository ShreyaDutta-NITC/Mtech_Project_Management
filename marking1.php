...
<div class="wrapper">
        <div class="title">Evaluation</div><br>
        <form action="includes/marking.inc.php "method="post" enctype="multipart/form-data">
            <div class="user-details">
                <div class="input-box">
                    <span class="details"><strong>Attachments</strong></span>
                    <?php
    ...
    ?>
                ...
                <div class="input-box">
                    <span class="details"><strong>Marks</strong></span>
                    <input type="text" name="marks" required>
                </div>
                <div class="input-box">
                    <span class="details"><strong>Remarks</strong></span>
                    <textarea type="text" name="remark" style="width:100%;" rows="4" cols="50" required></textarea>
                </div>
            ...
            <center><a style="color:grey;" href="super_profile.php">Go Back</a>
